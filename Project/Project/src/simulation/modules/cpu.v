    ...
    localparam LOAD_PC = 0, 
               ...
               DECODE = 5,
               LD_1_ADDR_D = 6, LD_1_X_D = 7, LD_1_DATA_D = 8, LD_1_ADDR_I = 9, LD_1_X_I = 10, LD_1_DATA_I = 11,
               LD_2_ADDR_D = 12, LD_2_X_D = 13, LD_2_DATA_D = 14, LD_2_ADDR_I = 15, LD_2_X_I = 16, LD_2_DATA_I = 17,
               EXECUTE_FAZE = 18,
               ST_ADDR_D = 19, ST_X_D = 20, ST_DATA_D = 21, ST_ADDR_I = 22, ST_DATA_I = 23,
               LD_RET_ADDR_D = 24, LD_RET_X_D = 25, LD_RET_DATA_D = 26, LD_RET_ADDR_I = 27, LD_RET_X_I = 28, LD_RET_DATA_I = 29,
               DISPLAY_OUT = 30,
               RESET = 31,
               FINISHED_1_ADDR_D = 32, FINISHED_1_X_D = 33, FINISHED_1_DATA_D = 34, FINISHED_1_ADDR_I = 35, FINISHED_1_X_I = 36, 
               FINISHED_1_DATA_I = 37, FINISHED_1_DISPLAY = 38,
               FINISHED_2_ADDR_D = 39, FINISHED_2_X_D = 40, FINISHED_2_DATA_D = 41, FINISHED_2_ADDR_I = 42, FINISHED_2_X_I = 43, FINISHED_2_DATA_I = 44, FINISHED_2_DISPLAY = 45,
               FINISHED_3_ADDR_D = 46, FINISHED_3_X_D = 47, FINISHED_3_DATA_D = 48, FINISHED_3_ADDR_I = 49, FINISHED_3_X_I = 50, FINISHED_3_DATA_I = 51, FINISHED_3_DISPLAY = 52,
               FINISHED_LOOP = 53;
    ...
    case(state)
        RESET: begin
            ...
            LD_2_DATA_D: begin
                ...
                if (oper_y_indirect)
                    next_state = LD_2_ADDR_I;//mdr <= mem[mem[y]]
                else
                    next_state = LD_1_ADDR_D; //mdr <= mem[y]
            end
...
//z,x,y - 1. 2. 3. operand
            LD_1_ADDR_D: begin 
                acc_ld  = 1'b1;
                acc_in  = mdr_out; //privremeno cuvanje operanda iz mdr u akumulatoru
                mar_ld = 1'b1;
                ...
                if (oper_x_indirect) 
                    ...
                    case (opcode)
                        ...
                        DIV: begin
                            ...
                            alu_a = mdr_out;   
                            alu_b = acc_out; //vrednost prethodno sacuvana u akumulatoru
                            case (opcode)
                                ADD: oc = 3'b000;
                                SUB: oc = 3'b001;
                                MUL: oc = 3'b010;
